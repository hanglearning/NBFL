...
def get_dataset_cifar10_extr_noniid(n_clients, n_classes, n_samples, rate_unbalance):
    data_dir = '../data/cifar/'
    apply_transform = transforms.Compose(
        [transforms.ToTensor(),
    ...
    user_groups_train, user_groups_test = cifar_extr_noniid(train_dataset, test_dataset, n_clients, n_classes, n_samples, rate_unbalance)
    return train_dataset, test_dataset, user_groups_train, user_groups_test

def get_dataset_mnist_extr_noniid(n_clients, n_classes, n_samples, rate_unbalance):
    data_dir = '../data/mnist/'
    apply_transform = transforms.Compose([
            transforms.ToTensor(),
            transforms.Normalize((0.1307,), (0.3081,))])
    ...
    # Chose euqal splits for every user
    user_groups_train, user_groups_test = mnist_extr_noniid(train_dataset, test_dataset, n_clients, n_classes, n_samples, rate_unbalance)
    return train_dataset, test_dataset, user_groups_train, user_groups_test

def get_dataset_miniimagenet_extr_noniid(n_clients, n_classes, n_samples, rate_unbalance):
    ...
    # Chose euqal splits for every user
    user_groups_train, user_groups_test = miniimagenet_extr_noniid(train_dataset, test_dataset, n_clients, n_classes, n_samples, rate_unbalance)
    return train_dataset, test_dataset, user_groups_train, user_groups_test
