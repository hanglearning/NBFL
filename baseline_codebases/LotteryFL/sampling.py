...
def mnist_iid(dataset, n_clients):
    """
...
def mnist_noniid(dataset, n_clients):
    """
...
def mnist_noniid_unequal(dataset, n_clients):
    """
...
def cifar_iid(dataset, n_clients):
    """
...
def cifar_noniid(dataset, n_clients):
    """
