...
# filepath: /Users/chenhang/Documents/Working/NBFL/plotting/plot_avg_stake.py
        ...
        for alpha in [1.0]:
            ...
            for lp in NBFL_log_paths:
                ...
                with open(f'{lp}/logger.pickle', 'rb') as file:
                    ...
                    NBFL_avg_stake_over_runs.append(avg_stake_over_rounds) 

            mean_lines = np.mean(NBFL_avg_stake_over_runs, axis=0) # op5: average over runs by same devices in the same round
            ...
            plt.savefig(f'{log_base_path}/NBFL/logs/avg_stake_mal_{mal}_attack_{attack_type}_alpha_{alpha}.png', dpi=300)
            plt.clf()
            # plt.show()